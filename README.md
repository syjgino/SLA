...
<!-- Getting Started -->
## Getting Started
1. Download the latest release of [SLA_V1.21](https://github.com/syjgino/SLA/releases) from Github and extract the zip file. Then run SLA_V1.21.exe.
...
[Proteowizard](http://proteowizard.sourceforge.net/download.html). (Note: Sometimes, their new updated version may not convert the data or file name correctly. 
We have tested version 3.0.21245.5724 and backed it up in this git.)
