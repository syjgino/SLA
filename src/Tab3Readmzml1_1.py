...
def readMZML(dirloc_read, sp_dict1_loc, std_dict_loc, proname3, 
    ...
    ##read spname dict
    sp_dict = {}
    sp_dict['1'] = pd.read_excel(sp_dict1_loc.get('1.0', 'end-1c'), sheet_name = '1', header=0, index_col=-1, na_values='.')
    sp_dict['2'] = pd.read_excel(sp_dict1_loc.get('1.0', 'end-1c'), sheet_name = '2', header=0, index_col=-1, na_values='.')
    
    #read standard dict
    std_dict = {}
    std_dict['1'] = pd.read_excel(std_dict_loc.get('1.0', 'end-1c'), sheet_name = 'Method1', header=0, index_col=0, na_values='.').to_dict()
    std_dict['2'] = pd.read_excel(std_dict_loc.get('1.0', 'end-1c'), sheet_name = 'Method2', header=0, index_col=0, na_values='.').to_dict()
    ...
    if len(out_df2_con['1'])>0:
        FA_con = {'1' : out_df2_con['1'][out_df2['1'].columns[-pd.Series(out_df2_con['1'].columns).str.split('(', expand=True)[0].isin(['PE','PC','PG','PI','PS'])]]}
    if len(out_df2_con['2'])>0:
        FA_con['2'] = out_df2_con['2'][out_df2['2'].columns[-pd.Series(out_df2_con['2'].columns).str.split('(', expand=True)[0].isin(['DAG'])]]
        FA_con['2'] = FA_con['2'][FA_con['2'].columns[-pd.Series(FA_con['2'].columns).str[0:3].isin(['TAG'])]]
    
    if len(out_df2_con['1'])>0:
        #PC
        PC_con = out_df2_con['1'][out_df2_con['1'].columns[pd.Series(out_df2_con['1'].columns).str.split('(', expand=True)[0].isin(['PC'])]]
        PC_con_1 = PC_con[:]
        ...
        #PE
        PE_con = out_df2_con['1'][out_df2_con['1'].columns[pd.Series(out_df2_con['1'].columns).str.split('(', expand=True)[0].isin(['PE'])]]
        PE_con_1 = PE_con[:]
        ...
        #PG
        PG_con = out_df2_con['1'][out_df2_con['1'].columns[pd.Series(out_df2_con['1'].columns).str.split('(', expand=True)[0].isin(['PG'])]]
        PG_con_1 = PG_con[:]
        ...
        #PI
        PI_con = out_df2_con['1'][out_df2_con['1'].columns[pd.Series(out_df2_con['1'].columns).str.split('(', expand=True)[0].isin(['PI'])]]
        PI_con_1 = PI_con[:]
        ...
        #PS
        PS_con = out_df2_con['1'][out_df2_con['1'].columns[pd.Series(out_df2_con['1'].columns).str.split('(', expand=True)[0].isin(['PS'])]]
        PS_con_1 = PS_con[:]
    ...
    #DAG
    if len(out_df2_con['2']) > 0:
        DAG_con = out_df2_con['2'][out_df2_con['2'].columns[pd.Series(out_df2_con['2'].columns).str.split('(', expand=True)[0].isin(['DAG'])]]
        DAG_con_1 = DAG_con[:]
