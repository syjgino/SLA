...
def readMZML(dirloc_read, sp_dict1_loc, std_dict_loc, proname3, 
    ...
    ##read spname dict
    sp_dict = {}
    sp_dict['1'] = pd.read_excel(sp_dict1_loc.get('1.0', 'end-1c'), sheet_name = '1', header=0, index_col=3, na_values='.')
    sp_dict['2'] = pd.read_excel(sp_dict1_loc.get('1.0', 'end-1c'), sheet_name = '2', header=0, index_col=3, na_values='.')
